            ...
            <div>
                <form method="post"
                    ...
                    <div class="text-center xl:text-right md:space-x-3">
                        ...
                        <div class="relative block md:inline-block w-full md:w-[30%]">
                            <label>
                            ...
                            @error('nom')
                            <div class="absolute -bottom-[30px] text-base font-bold text-red-500">
                                {{ $message }}
                            </div>
                            @enderror
                        </div>

                        <div class="relative block md:inline-block w-full md:w-[40%] mt-4 md:mt-0">
                            <label>
