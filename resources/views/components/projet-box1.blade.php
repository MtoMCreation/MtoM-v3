    ...
    <a href="{{ route('projet.show', $projet) }}"
       class="article-box relative flex flex-col justify-between md:transform hover:-translate-y-2 transition duration-500 ease-in-out">
        <div class="article-box-content">
            ...
            @endif
            <img src="{{ asset($projet->logo) }}" alt="image client-{{ Str::slug($projet->client) }}-{{ config('app.tagline') }}"
                 class="absolute w-[50px] bg-white p-2 z-50" style="border-bottom-right-radius: 10px">
