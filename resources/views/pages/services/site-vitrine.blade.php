    ...
    <div>
        ...
        <div class="hero-section container lg:flex items-center md:space-x-14 py-20 h-hero" >
            ...
            <div class="lg:w-8/12">
                ...
                <p class="mt-8">
                    Chez MtoM, nous sommes spécialisés dans la <b>création de site web vitrine sur mesure.</b>
                    Véritable outil de communication, le site web véhicule l’image de votre entreprise auprès de vos clients, vos fournisseurs et vos partenaires. Indispensable dans le développement de votre activité, nous vous créons <b>un site web sur mesure, 100% personnalisable qui répondra à tous vos besoins.</b>
                </p>
        ...
        <div class="page-section-1 flex items-center shadow-xl">
            <div class="container">
                ...
                <div x-data="{
                    unOpen: true,
                    toggleUn() { this.unOpen = true, this.deuxOpen = false, this.troisOpen = false, this.quatreOpen = false },
                    ...
                    <div class="mt-4">
                        <p x-show="unOpen" class="md:p-5 md:bg-gray-50 md:rounded-lg">
                            ...
                            <br>
                            Voici un article qui pourra vous aider dans cette étape : <a href="https://mtom-creation.com/article/creation-dun-site-web-les-questions-a-se-poser-avant-de-commencer" target="_blank" class="font-bold text-mtom-orange">Création d’un site web : Les questions à se poser avant de commencer </a>
                        </p>

                        <p x-show="deuxOpen" class="md:p-5 md:bg-gray-50 md:rounded-lg">
                            <b>Création de votre site web sur mesure </b>
                            <br>
                            C’est la phase de conception, là où vos idées prennent vie. Nous utilisons le cahier des charges créé précédemment pour élaborer la structure de votre futur site web et vous proposer les premières maquettes. Durant la création de votre site web, vous pourrez voir l’avancée grâce à un lien que nous vous transmettrons. Cela nous permettra d’avoir un retour sur vos premières impressions et de réajuster. Il arrive souvent que des idées qui vous paraissent bonnes sur le papier ne correspondent finalement pas ce que vous souhaitez. Nous restons donc en contact régulier pour que votre site web soit exactement ce que vous souhaitez. Notre objectif : vous créer un site web qui correspond parfaitement à vos attentes et répond à vos besoins
                        </p>
                        ...
                        <p x-show="quatreOpen" class="md:p-5 md:bg-gray-50 md:rounded-lg">
                            <b>Nous restons là pour vous accompagner</b>
                            <br>
        ...
        <div class="page-section-1 flex items-center shadow-xl">
            <div class="container">
                ...
                <div class="font-black font-title uppercase">
                    ...
                    <h2 class="title-2 text-mtom-blue">
                        Exemples de <span class="text-mtom-orange">sites vitrines</span>
                    </h2>
                </div>
            ...
            <div class="container">
                ...
                <div class="text-white mt-6">
                    ...
                    <div class="space-y-8 mt-8">
                        ...
                        <x-icon-box-faq-1 titre="Quels sont les délais pour la création d'un site web ?"
                                      path="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z">
                            Pour la création d'un site web professionnel complet, il faut compter en moyenne entre 1 et 2 mois. Cela va de l'élaboration du cahier des charges à la mise en ligne. Nous sommes capables de tenir des délais plus courts mais par expérience, la validation des propositions de maquettes est une phase qui prend toujours plus de temps que prévu.
                        </x-icon-box-faq-1>

                        <x-icon-box-faq-1 titre="Combien coûte la création d'un site web professionnel ?"
                                      path="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z">
                            Tout dépend des fonctionnalités que vous souhaitez intégrer à votre site web. Présentez-nous votre projet et nous pourrons vous fournir une soumission détaillée qui répondra parfaitement à vos objectifs. Nous proposons des forfaits tout inclus pour que vous n'ayez aucune surprise. Notre devise, payez uniquement pour ce dont vous avez besoin. Contactez-nous pour en savoir plus.
                        </x-icon-box-faq-1>

                        <x-icon-box-faq-1 titre="Quels sont les coûts récurrents liés à l'utilisation d'un site web ?"
                                                     path="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z">
                            Une fois votre nouveau site web fini et en ligne, les coûts récurrents sont l'hébergement et le nom de domaine. Pour l'hébergement Wordpress, nous proposons des solutions à 220$ par an. Concernant le nom de domaine, il faut compter en moyenne entre 15 et 25$ par année. Pour certains noms de domaine, les prix peuvent être plus élevés. (vous pouvez vous renseigner sur le site web GoDaddy)
                        </x-icon-box-faq-1>
                        ...
                        <x-icon-box-faq-1 titre="Comment faire des modifications sur mon site web une fois en ligne ?"
                            ...
                            Pas de panique ! Nous vous formons pour que vous soyez totalement autonome dans la gestion quotidienne de votre site web. Ajout de contenu, modification de texte, changement d'images, mises à jour de sécurité... Vous n'aurez plus besoin de personne.
                            <br>
